...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/azure-batch-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12000&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/azure-batch-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `azure-batch` can be installed with:

```
conda install azure-batch
```

It is possible to list all of the versions of `azure-batch` available on your platform with:
